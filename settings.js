...
global.owner = process.env.OWNER_NUMBER  || '256785816014' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=Wd03TJKY#JcQQmpS2mzE2D7PSnKpz_zTbWFiuhRoI8RIxh0uu0fQ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "256785816014,256708726960" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'JURUA RONE' ,
